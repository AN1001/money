...
if(isset($_POST["submit"]) && !empty($_POST['Iusername']) && !empty($_POST['Ipassword']) && !empty($_POST['Iconfpassword']) ) {
  ...
  function createUser($conn, $username, $password) {
    echo "user created!";
    $accountCreate = "INSERT INTO userinfo (username, password, graphdata) VALUES ('$username', '$password', '[[\"ExampleGraph1\",\"JUN2022-JUL2022\",[\"Morrisons\",22.50],[\"Sainsbury\",0.50],[\"Aldi\",111.90]],[\"ExampleGraph2\",\"JUL2022\",[\"Gas\",12.43],[\"Water\",65.23],[\"Electricity\",10],[\"TV\",0.20]],[\"ExampleGraph3\",\"JAN2022-MAY2022\",[\"Pizza\",20],[\"Mac\",4.50],[\"Rice\",2.10],[\"Pizza 2\",20],[\"Pizza 3\",6.40],[\"Burrito\",0.30],[\"Lobster\",33],[\"Protein\",12],[\"Mac 2\",4.50],[\"Pizza 4\",25],[\"Pizza 5\",20],[\"Mac 3\",4.50],[\"Rice 2\",2.10],[\"Pizza 6\",20],[\"Pizza 7\",6.40],[\"Burrito 2\",0.30],[\"Lobster 2\",33],[\"Protein 3\",12],[\"Mac 4\",4.50],[\"Pizza 7\",25]]]')";
    pg_query($conn, $accountCreate);
    setcookie("graphData", "[[\"ExampleGraph1\",\"JUN2022-JUL2022\",[\"Morrisons\",22.50],[\"Sainsbury\",0.50],[\"Aldi\",111.90]],[\"ExampleGraph2\",\"JUL2022\",[\"Gas\",12.43],[\"Water\",65.23],[\"Electricity\",10],[\"TV\",0.20]],[\"ExampleGraph3\",\"JAN2022-MAY2022\",[\"Pizza\",20],[\"Mac\",4.50],[\"Rice\",2.10],[\"Pizza 2\",20],[\"Pizza 3\",6.40],[\"Burrito\",0.30],[\"Lobster\",33],[\"Protein\",12],[\"Mac 2\",4.50],[\"Pizza 4\",25],[\"Pizza 5\",20],[\"Mac 3\",4.50],[\"Rice 2\",2.10],[\"Pizza 6\",20],[\"Pizza 7\",6.40],[\"Burrito 2\",0.30],[\"Lobster 2\",33],[\"Protein 3\",12],[\"Mac 4\",4.50],[\"Pizza 7\",25]]]", time()+6000, '/');
  }   
